...
VEDA_TENSORS_API const char* veda_tensors_get_unary(const VEDATensors_unary_op op) {
	switch(op) {
		case VEDA_TENSORS_UNARYOP_ABS:			return "VEDA_TENSORS_UNARYOP_ABS";
		case VEDA_TENSORS_UNARYOP_ADD:			return "VEDA_TENSORS_UNARYOP_ADD";
		case VEDA_TENSORS_UNARYOP_ADDCDIV:		return "VEDA_TENSORS_UNARYOP_ADDCDIV";
		case VEDA_TENSORS_UNARYOP_ADDCMUL:		return "VEDA_TENSORS_UNARYOP_ADDCMUL";
		case VEDA_TENSORS_UNARYOP_CEIL:			return "VEDA_TENSORS_UNARYOP_CEIL";
		case VEDA_TENSORS_UNARYOP_COS:			return "VEDA_TENSORS_UNARYOP_COS";
		case VEDA_TENSORS_UNARYOP_DIV:			return "VEDA_TENSORS_UNARYOP_DIV";
		case VEDA_TENSORS_UNARYOP_EXP:			return "VEDA_TENSORS_UNARYOP_EXP";
		case VEDA_TENSORS_UNARYOP_FLOOR:		return "VEDA_TENSORS_UNARYOP_FLOOR";
		case VEDA_TENSORS_UNARYOP_IMAG:			return "VEDA_TENSORS_UNARYOP_IMAG";
		case VEDA_TENSORS_UNARYOP_ISFINITE:		return "VEDA_TENSORS_UNARYOP_ISFINITE";
		case VEDA_TENSORS_UNARYOP_ISINF:		return "VEDA_TENSORS_UNARYOP_ISINF";
		case VEDA_TENSORS_UNARYOP_ISNAN:		return "VEDA_TENSORS_UNARYOP_ISNAN";
		case VEDA_TENSORS_UNARYOP_LOG:			return "VEDA_TENSORS_UNARYOP_LOG";
		case VEDA_TENSORS_UNARYOP_MAX:			return "VEDA_TENSORS_UNARYOP_MAX";
		case VEDA_TENSORS_UNARYOP_MIN:			return "VEDA_TENSORS_UNARYOP_MIN";
		case VEDA_TENSORS_UNARYOP_MUL:			return "VEDA_TENSORS_UNARYOP_MUL";
		case VEDA_TENSORS_UNARYOP_REAL:			return "VEDA_TENSORS_UNARYOP_REAL";
		case VEDA_TENSORS_UNARYOP_RECIPROCAL:	return "VEDA_TENSORS_UNARYOP_RECIPROCAL";
		case VEDA_TENSORS_UNARYOP_RSQRT:		return "VEDA_TENSORS_UNARYOP_RSQRT";
		case VEDA_TENSORS_UNARYOP_SIN:			return "VEDA_TENSORS_UNARYOP_SIN";
		case VEDA_TENSORS_UNARYOP_SQRT:			return "VEDA_TENSORS_UNARYOP_SQRT";
		case VEDA_TENSORS_UNARYOP_SUB:			return "VEDA_TENSORS_UNARYOP_SUB";
		case VEDA_TENSORS_UNARYOP_TAN:			return "VEDA_TENSORS_UNARYOP_TAN";
	}
	return "VEDA_TENSORS_UNARYOP_UNKNOWN";
}

//------------------------------------------------------------------------------
VEDA_TENSORS_API const char* veda_tensors_get_unary(const VEDATensors_reduce_op op) {
	switch(op) {
		case VEDA_TENSORS_REDUCEOP_L0:		return "VEDA_TENSORS_REDUCEOP_L0";
		case VEDA_TENSORS_REDUCEOP_L1:		return "VEDA_TENSORS_REDUCEOP_L1";
		case VEDA_TENSORS_REDUCEOP_L2:		return "VEDA_TENSORS_REDUCEOP_L2";
		case VEDA_TENSORS_REDUCEOP_MAX:		return "VEDA_TENSORS_REDUCEOP_MAX";
		case VEDA_TENSORS_REDUCEOP_MEAN:	return "VEDA_TENSORS_REDUCEOP_MEAN";
		case VEDA_TENSORS_REDUCEOP_MIN:		return "VEDA_TENSORS_REDUCEOP_MIN";
		case VEDA_TENSORS_REDUCEOP_SUM:		return "VEDA_TENSORS_REDUCEOP_SUM";
	}
	return "VEDA_TENSORS_REDUCEOP_UNKNOWN";
}

//------------------------------------------------------------------------------
VEDA_TENSORS_API const char* veda_tensors_get_dtype(const VEDATensors_dtype op) {
	switch(op) {
		case VEDA_TENSORS_DTYPE_BOOL:		return "VEDA_TENSORS_DTYPE_BOOL";
...
VEDA_TENSORS_API int veda_tensors_dtype_bytes(const VEDATensors_dtype op) {
	switch(op) {
		case VEDA_TENSORS_DTYPE_BOOL:		return 1;
...
//------------------------------------------------------------------------------
VEDA_TENSORS_API const char* veda_tensors_get_dtype(const VEDATensors_binary_op op) {
	switch(op) {
		case VEDA_TENSORS_BINARYOP_AND:	return "VEDA_TENSORS_BINARYOP_AND";
		case VEDA_TENSORS_BINARYOP_EQ:	return "VEDA_TENSORS_BINARYOP_EQ";
		case VEDA_TENSORS_BINARYOP_GE:	return "VEDA_TENSORS_BINARYOP_GE";
		case VEDA_TENSORS_BINARYOP_GT:	return "VEDA_TENSORS_BINARYOP_GT";
		case VEDA_TENSORS_BINARYOP_LE:	return "VEDA_TENSORS_BINARYOP_LE";
		case VEDA_TENSORS_BINARYOP_LT:	return "VEDA_TENSORS_BINARYOP_LT";
		case VEDA_TENSORS_BINARYOP_NE:	return "VEDA_TENSORS_BINARYOP_NE";
		case VEDA_TENSORS_BINARYOP_OR:	return "VEDA_TENSORS_BINARYOP_OR";
		case VEDA_TENSORS_BINARYOP_XOR:	return "VEDA_TENSORS_BINARYOP_XOR";
	}
	return "VEDA_TENSORS_BINARYOP_UNKNOWN";
}

//------------------------------------------------------------------------------
VEDA_TENSORS_API const char* veda_tensors_get_dtype(const VEDATensors_bitwise_op op) {
	switch(op) {
		case VEDA_TENSORS_BITWISEOP_AND:	return "VEDA_TENSORS_BITWISEOP_AND";
		case VEDA_TENSORS_BITWISEOP_OR:		return "VEDA_TENSORS_BITWISEOP_OR";
		case VEDA_TENSORS_BITWISEOP_XOR:	return "VEDA_TENSORS_BITWISEOP_XOR";
	}
	return "VEDA_TENSORS_BITWISEOP_UNKNOWN";
}
...
VEDA_TENSORS_API const char* veda_tensors_get_kernel(const VEDATensors_kernel kernel) {
	switch(kernel) {
		...
		case VEDA_TENSORS_KERNEL_MASKED_FILL_T:			return "VEDA_TENSORS_KERNEL_MASKED_FILL_T";
		...
		case VEDA_TENSORS_KERNEL_REDUCE_SCALAR:			return "VEDA_TENSORS_KERNEL_REDUCE_SCALAR";
...
VEDA_TENSORS_API const char* veda_tensors_get_kernel_func(const VEDATensors_kernel kernel) {
	switch(kernel) {
		...
		case VEDA_TENSORS_KERNEL_MASKED_FILL:		return "veda_tensors_fill";
		case VEDA_TENSORS_KERNEL_MASKED_FILL_T:		return "veda_tensors_fill_t";
		case VEDA_TENSORS_KERNEL_MASKED_SCATTER:	return "veda_tensors_scatter";
		case VEDA_TENSORS_KERNEL_MASKED_SELECT:		return "veda_tensors_select";
		...
		case VEDA_TENSORS_KERNEL_REDUCE_SCALAR:		return "veda_tensors_reduce_scalar";
